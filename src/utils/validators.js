...
export const passwordsMatch = vals =>
  vals.user && vals.user.password === vals.user.passwordConfirmation
export const passwordMinLength = vals =>
  vals.user && vals.user.password.length >= 6
export const email = vals =>
  vals.user &&
